...
static void __init arch_mem_init(char **cmdline_p)
{
	...
	if (builtin_cmdline[0]) {
		/* Make sure not to duplicate any args */
		size_t builtin_len = strnlen(builtin_cmdline, COMMAND_LINE_SIZE);
		if (memcmp(boot_command_line, builtin_cmdline, builtin_len)
			|| (boot_command_line[builtin_len] != '\0'
