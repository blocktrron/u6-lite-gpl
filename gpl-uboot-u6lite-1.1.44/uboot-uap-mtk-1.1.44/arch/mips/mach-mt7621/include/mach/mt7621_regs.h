...
#define REG_MAKE_VAL(_name, _val) \
	(((_name ## _M) & (_val)) << (_name ## _S))

#define REG_MAKE_MASK(_name) \
	((_name ## _M) << (_name ## _S))
...
#define MT7621_GPIO_MODE_BASE				0x1e000060
#define MT7621_GPIO_MODE_SIZE				0x100
...
#define MT7621_I2C_BASE					0x1e000900
#define MT7621_I2C_SIZE					0x100
...
#define MT7621_SYS_PAD_RGMII2_MDIO_CFG_REG		0x58
#define   RGMII2_RDSEL_S				  28
#define   RGMII2_RDSEL_M				  0x03
#define   RGMII2_TDSEL_S				  24
#define   RGMII2_TDSEL_M				  0x0f
#define   RGMII2_E4_E2_S				  20
#define   RGMII2_E4_E2_M				  0x03
#define   RGMII2_PU_S					  19
#define   RGMII2_PU_M					  0x01
#define   RGMII2_PD_S					  18
#define   RGMII2_PD_M					  0x01
#define   RGMII2_SMT_S					  17
#define   RGMII2_SMT_M					  0x01
#define   RGMII2_SR_S					  16
#define   RGMII2_SR_M					  0x01
#define   MDIO_RDSEL_S					  12
#define   MDIO_RDSEL_M					  0x03
#define   MDIO_TDSEL_S					  8
#define   MDIO_TDSEL_M					  0x0f
#define   MDIO_E4_E2_S					  4
#define   MDIO_E4_E2_M					  0x03
#define   MDIO_PU_S					  3
#define   MDIO_PU_M					  0x01
#define   MDIO_PD_S					  2
#define   MDIO_PD_M					  0x01
#define   MDIO_SMT_S					  1
#define   MDIO_SMT_M					  0x01
#define   MDIO_SR_S					  0
#define   MDIO_SR_M					  0x01
...
/* MT7621_GPIO_BASE */
#define MT7621_GPIO_CTRL0_REG				0x0000
#define MT7621_GPIO_CTRL1_REG				0x0004
#define MT7621_GPIO_CTRL2_REG				0x0008
#define MT7621_GPIO_DATA0_REG				0x0020
#define MT7621_GPIO_DATA1_REG				0x0024
#define MT7621_GPIO_DATA2_REG				0x0028
#define MT7621_GPIO_DSET0_REG				0x0030
#define MT7621_GPIO_DSET1_REG				0x0034
#define MT7621_GPIO_DSET2_REG				0x0038
#define MT7621_GPIO_DCLR0_REG				0x0040
#define MT7621_GPIO_DCLR1_REG				0x0044
#define MT7621_GPIO_DCLR2_REG				0x0048
