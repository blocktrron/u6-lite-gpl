...
typedef enum ddr_reinit_type
{
	DDR_NOREINIT = 0,
	DDR_REINIT_NORMAL,
	DDR_REINIT_AUTO_PROBE,
	DDR_REINIT_AUTO_PROBE_PHASE2,
	DDR_REINIT_AUTO_PROBE_PHASE3,
	DDR_REINIT_AUTO_PROBE_PHASE4,
	DDR_REINIT_GIVE_UP
} ddr_reinit_type_t;
