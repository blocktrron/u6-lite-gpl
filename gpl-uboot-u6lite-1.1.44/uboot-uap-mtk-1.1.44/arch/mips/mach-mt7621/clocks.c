...
void mt7621_get_clocks(u32 *pcpu_clk, u32 *pbus_clk, u32 *pxtal_clk)
{
	...
	u32 bs, xtal_sel, clkcfg0, cur_clk, mempll18, xtal_clk, xtal_div, ffiv, ffrac;
	u32 cpu_clk;
	...
	case 1:
		...
		xtal_div = 1 << xtal_div_tbl[REG_GET_VAL(RG_MEPL_PREDIV, mempll18)];
		cpu_clk = (REG_GET_VAL(RG_MEPL_FBDIV, mempll18) + 1) * xtal_clk / xtal_div;
		break;
	default:
		cpu_clk = xtal_clk;
	}
