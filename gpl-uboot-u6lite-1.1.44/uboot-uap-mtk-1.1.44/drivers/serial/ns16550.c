...
//Fix compile error when CONFIG_DM_SERIAL=y, bsp doesn't contain the following code
#ifndef CONFIG_UBNT_SUPPORT_MTK_BLE
	com_port = (struct NS16550 *)CONFIG_SYS_NS16550_COM2;
	baud_divisor = ns16550_calc_divisor(com_port, CONFIG_DEBUG_UART_CLOCK,
					    CONFIG_BAUDRATE);
	serial_dout(&com_port->ier, CONFIG_SYS_NS16550_IER);
	serial_dout(&com_port->mcr, UART_MCRVAL);
