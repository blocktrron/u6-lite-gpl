...
#if defined (CONFIG_UBNT_MT7621_SPI_MTD_LAYOUT_DEFAULT)
...
#elif defined (CONFIG_UBNT_MT7621_MTD_LAYOUT_CUSTOMIZE)
#define FIRMWARE_OFFSET		CONFIG_MT7621_FIRMWARE_OFFSET_DEFAULT
#endif

void board_mtdparts_default(const char **mtdids, const char **mtdparts)
{
#ifndef CONFIG_UBNT_MT7621_MTD_LAYOUT_CUSTOMIZE
	*mtdids = def_mtdids;
