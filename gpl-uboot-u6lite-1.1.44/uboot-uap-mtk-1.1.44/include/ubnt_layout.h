...
#define UBNT_PART_UBOOT_KSIZE               (CONFIG_UBNT_PART_UBOOT_KSIZE)
#define UBNT_PART_UBOOT_ENV_KSIZE           (CONFIG_UBNT_PART_UBOOT_ENV_KSIZE)
#define UBNT_PART_FACTORY_KSIZE             (CONFIG_UBNT_PART_FACTORY_KSIZE)
#define UBNT_PART_EEPROM_KSIZE              (CONFIG_UBNT_PART_EEPROM_KSIZE)
#define UBNT_PART_BOOTSELECT_KSIZE          (CONFIG_UBNT_PART_BOOTSELECT_KSIZE)
#define UBNT_PART_CFG_KSIZE                 (CONFIG_UBNT_PART_CFG_KSIZE)
#define UBNT_PART_KERNEL0_KSIZE             (CONFIG_UBNT_PART_KERNEL0_KSIZE)
#define UBNT_PART_KERNEL1_KSIZE             (CONFIG_UBNT_PART_KERNEL1_KSIZE)
...
#define UBNT_PART_BOOTSELECT_NAME           "bootselect"
